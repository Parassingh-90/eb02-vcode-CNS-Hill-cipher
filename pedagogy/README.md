...
2.| User will be able to apply the concept of Hill Cipher and try to solve problem. | Type the task that <br> student will perform | 1 Hill cipher is an example of ____________ <br> A. mono-alphabetic cipher <br> B. substitution cipher <br> C.transposition cipher <br> <b> D. additive cipher </b> <br> (B)
